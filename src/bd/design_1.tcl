...
CONFIG.XML_INPUT_FILE.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port ddr3_sdram -pg 1 -y 720 -defaultsOSRD
...
preplace inst rst_mig_7series_0_83M -pg 1 -lvl 1 -y 340 -defaultsOSRD
preplace inst mig_7series_0 -pg 1 -lvl 4 -y 760 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 3 -y 570 -defaultsOSRD
...
preplace netloc mig_7series_0_mmcm_locked 1 0 5 30 690 NJ 690 NJ 690 1130J 670 1390
preplace netloc mig_7series_0_DDR3 1 4 1 NJ
preplace netloc microblaze_0_Clk 1 0 5 20 450 370 450 860 450 1150 450 1400
preplace netloc rst_mig_7series_0_83M_peripheral_aresetn 1 1 3 NJ 380 870 700 1150
...
preplace netloc sys_clock_1 1 0 3 NJ 820 NJ 820 NJ
preplace netloc rst_mig_7series_0_83M_mb_reset 1 1 1 380
preplace netloc microblaze_0_M_AXI_IC 1 2 1 N
preplace netloc clk_wiz_0_clk_out1 1 3 1 1170
preplace netloc axi_uartlite_0_UART 1 4 1 NJ
preplace netloc mig_7series_0_ui_clk_sync_rst 1 0 5 40 440 NJ 440 NJ 440 NJ 440 1410
preplace netloc clk_wiz_0_clk_out2 1 3 1 1160
preplace netloc microblaze_0_dlmb_1 1 2 1 830
preplace netloc microblaze_0_debug 1 1 1 N
preplace netloc rst_mig_7series_0_83M_interconnect_aresetn 1 1 2 NJ 360 840
preplace netloc mdm_1_debug_sys_rst 1 0 2 30 120 360
preplace netloc reset_1 1 0 4 NJ 740 NJ 740 850 740 NJ
preplace netloc rst_mig_7series_0_83M_bus_struct_reset 1 1 2 N 320 850J
levelinfo -pg 1 0 200 610 1000 1280 1430 -top 0 -bot 880
",
}
